...
obstacle(7,8,6,8,_,_,1,_).
obstacle(7,8,7,9,_,_,1,_).
obstacle(3,9,4,9,_,_,1,_).
obstacle(3,9,3,10,_,_,1,_).
obstacle(5,11,5,10,_,_,1,_).
obstacle(5,11,4,11,_,_,1,_).
obstacle(1,13,0,13,_,_,1,_).
obstacle(1,13,1,14,_,_,1,_).
obstacle(6,14,6,13,_,_,1,_).
...
obstacle(12,9,12,8,_,_,_,1).
obstacle(12,9,13,9,_,_,_,1).
obstacle(9,12,9,11,_,_,_,1).
obstacle(9,12,8,12,_,_,_,1).
obstacle(14,13,13,13,_,_,_,1).
